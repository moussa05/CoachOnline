...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoachOnline.Model.Course", b =>
                {
                    ...
                    b.Property<string>("CertificationQCM")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PublicTargets")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CoachOnline.Model.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CoachOnline.Model.User", b =>
                {
                    ...
                    b.Property<DateTime?>("EndOdDiscoveryModeEmailSendDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<byte>("EndOdDiscoveryModeStatus")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("CoachOnline.Model.UserDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CoachOnline.Model.WebLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CoachOnline.Model.User", b =>
                {
                    ...
                    b.HasOne("CoachOnline.Model.UserDocument", "UserCV")
                        .WithMany()
